    ...
    <section className="border-b border-blue-100 bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-16 md:flex-row md:items-center md:justify-between md:py-24">
        <div className="flex-1">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-blue-50 px-3.5 py-1.5 text-sm text-blue-700">
          ...
          <div className="mb-10 flex flex-wrap gap-4">
            ...
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-white px-5 py-3 text-sm font-medium text-blue-700 transition hover:bg-blue-50"
            >
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="h-9 w-9 rounded-full border-2 border-white bg-blue-100"
                  aria-hidden
                />
              ))}
            </div>
          ...
          <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-6 shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-3">
              {["Mon", "Tue", "Wed"].map((day) => (
                <div key={day}>
                  <div
                    className="h-16 rounded-lg bg-blue-100/80"
                    aria-hidden
                  />
